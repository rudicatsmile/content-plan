...
export default async function MediaPengajuanPage() {
  ...
  if (!profile || (profile.role !== 'media_admin' && profile.role !== 'super_admin')) {
    return (
      <div className="p-8">
        <h1 className="text-2xl font-bold text-red-500">Akses Ditolak</h1>
        <p>Hanya Media Admin atau Super Admin yang dapat mengakses halaman ini.</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Daftar Pengajuan</h1>
      </div>
